...
const LoginForm = () => {
  ...
  return (
    <Box
      ...
      sx={{ backgroundColor: "#092B38", padding: 1, borderRadius: 1, mt: 2 }}
    >
      <Toolbar
        sx={{
      ...
      >
        <Typography variant="h2" color="white" sx={{fontWeight:'bold', fontSize:'2.5em'}}>
          Login
        </Typography>
      </Toolbar>
      <Box
      ...
      >
        ...
        />
        <Button type="submit" variant="contained" fullWidth color="primary" sx={{backgroundColor:'#092B38', '&:hover': {backgroundColor:'#3D94B6', color:'black'}, transition:'0.7s'}}>
          {" "}
          Entrar{" "}
        </Button>
      </Box>
