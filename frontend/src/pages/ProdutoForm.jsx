        ...
        <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ backgroundColor: "#AAE7FF", padding: 2, borderRadius: 1, mt: 2 }}>
            ...
            <Box sx={{ backgroundColor: 'white', padding: 2, borderRadius: 3, mb: 2 }}>
                ...
                <Box sx={{ mt: 2 }}>
                    ...
                    <Button variant="contained" component="label" disabled={isReadOnly} sx={{ backgroundColor: '#092B38', '&:hover': { backgroundColor: '#004561' }, border: 'none', outline: 'none', transition: '1s' }}>
                        Selecione a Imagem
                ...
                <Box sx={{ display: "flex", justifyContent: "flex-end", mt: 2 }}>
                    <Button onClick={() => navigate('/produtos')} sx={{ mr: 1, backgroundColor: 'transparent', border: 'none', outline: 'none', color: '#092B38', transition: '1s', '&:hover': { backgroundColor: '#004561', color: 'white' } }}>Cancelar</Button>
                    {opr !== 'view' && (
